...
# Add missing stdlib.h include to fix build
# Not upstreamed as upstream refactored this code in 6.x
Patch2:         0001-Add-missing-stdlib.h-include-to-pwd_conf_update.c.patch
BuildRequires:  make
BuildRequires:  gcc
